...
export function AppHeader({ title, subtitle, back, actions }: AppHeaderProps) {
  return (
    <div className="shrink-0 flex items-center justify-between px-6 bg-[var(--brikii-bg)] border-b border-[var(--brikii-border)] mb-6" style={{ minHeight: 'var(--brikii-header-h)' }}>
